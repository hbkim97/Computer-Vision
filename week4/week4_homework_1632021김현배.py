'''
기존 올려드린 hansung.mp4 (1280x720) 파일과 첨부의 video1.mp4 (1280x720) 파일을 이용해
아래와 같이 hansung.mp4 영상 1280x720 내 특정 위치에서는 video1.mp4가 가로:320x세로:240 크기로 재생되도록 구현하세요.
이미지 프레임 크기 변환은 cv2.resize() 함수 이용법을 검색하여 이용하세요. 전체 동영상 길이는 video1.mp4에 맞춥니다.
'''
